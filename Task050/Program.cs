...
//Условие задачи поставлены не однозначно и требуют уточнения для реализациию
//В моем решении я по заданным позициям элемента ищет этот элемент или говорит, что такого элемента нет
